package com.icyfillup.rain.graphics;
...
//				if(sprite == null) { System.err.println("Sprite is null."); }
			}
		}
	...
	private void load() 
	{
		...
		{
			e.printStackTrace();
			System.out.println("Failed! First Catch in SpriteSheet Class");
		}
		catch (Exception e)
		{
			e.printStackTrace();
			System.out.println("Failed! Second Catch in SpriteSheet Class");
		}
	}
}
